# EXOTIC COLAB (EXOplanet Transit Interpretation Code) Colab Library
...
This package contains styling, interaction, and functional methods that support the use of EXOTIC in Google Colab. It was originally built for UX improvements to EXOTIC. EXOTIC is a Python 3 package for analyzing photometric data of transiting exoplanets into lightcurves and retrieving transit epochs and planetary radii.
